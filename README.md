...
> **Note:** Umbraco 14.x is not currently supported due to breaking API changes in the property editor infrastructure. Support for this version is being worked on.
