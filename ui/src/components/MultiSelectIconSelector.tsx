...
import { CollectionGroup, CollectionGroupHeader, IconButton, IconGrid, IconGridGrouped, IconGridInner } from '../styles';
...
export const MultiSelectIconSelector = ({
        ...
        {Object.entries(groupedIcons).map(([collectionPrefix, collectionIcons]) => (
          <CollectionGroup key={collectionPrefix}>
            <CollectionGroupHeader>
              <span>{getCollectionName(collectionPrefix)}{' '}[{collectionIcons.length}]</span>
              <LicenseInfo collection={collectionPrefix} compact={true} />
            </CollectionGroupHeader>
            <IconGridGrouped>
  ...
  // Render non-grouped icons (single collection mode)
